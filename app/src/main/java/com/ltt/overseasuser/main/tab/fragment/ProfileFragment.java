...
import com.ltt.overseasuser.main.tab.fragment.activity.PaymentActivity;
import com.ltt.overseasuser.main.tab.fragment.activity.PersonInfomationActivity;
...
public class ProfileFragment extends BaseFragment {
    ...
    protected void prepareFragment() {
        ...
        vp.setAdapter(new GamePager(getFragmentManager()));
